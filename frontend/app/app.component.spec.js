...
describe('AppComponent', () => {
    ...
    it(`should have as title 'medinsky'`, testing_1.async(() => {
        const fixture = testing_1.TestBed.createComponent(app_component_1.AppComponent);
        const app = fixture.debugElement.componentInstance;
        expect(app.title).toEqual('medinsky');
    }));
    it('should render title in a h1 tag', testing_1.async(() => {
        const fixture = testing_1.TestBed.createComponent(app_component_1.AppComponent);
        fixture.detectChanges();
        const compiled = fixture.debugElement.nativeElement;
        expect(compiled.querySelector('h1').textContent).toContain('Welcome to medinsky!');
    }));
});
